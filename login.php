    ...
    if ( !empty($enteredUsername) && !empty($enteredPassword) )   { 
        ...
        if (!empty($result) && ($count > 0) ) {
            ...
            if (password_verify($enteredPassword, $storedHash) ) {
                ...
                header(REFRESH_TIME . 'url=list_item.php');		//to view the password hashes and login success/failure
...
<body>
    <div id="main_container">
        ...
        <div id="header">
            <div class="logo">
                <img src="img/gtbay_logo.jpg" style="opacity:0.5;background-color:E9E5E2;" border="0" alt="" title="GT Online Logo"/>
            </div>
        </div>
